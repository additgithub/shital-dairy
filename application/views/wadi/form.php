...
$wadi_name = array('name' => 'wadi_name', 'id' => 'wadi_name', 'value' => (isset($data_info) && $data_info->wadi_name != "") ? $data_info->wadi_name : set_value('wadi_name'), 'class' => "form-control",);
                ...
                <div class=" form">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="form-label">Wadi Name<span class="spn_required">*</span></label>
                            <div class="input-with-icon  right">

                                <?php
                                echo form_input($wadi_name);
                                ?>
                            </div>
                        </div>
