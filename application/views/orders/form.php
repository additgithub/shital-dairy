...
<script>
    ...
    function addItemRow(existing = null) {
        ...
        <div class="form-group col-md-2 cus_filds">
            <label>Qty (KG)</label>
            <input type="number" name="item_qty[]" class="form-control item_qty" min="1" title="Available: ${available_pkt} pkt"  value="${qty}" data-price="0" oninput="updateRowPrice(this)" required>
        </div>
        <div class="form-group col-md-2 cus_filds">
            <label>Price Per KG</label>
            <input type="number" name="item_qty_left[]" class="form-control item_qty_left" min="1" max="${availableAttr2}" title="  value="${availableAttr2} Avalaible PKT">
        </div>
        <div class="form-group col-md-2 cus_filds">
            <label>Total Amount</label>
    ...
    function updateRowPrice(el) {
        ...
        const availble_qty = row.find('.item_qty_left');
        ...
        availble_qty.val(sellingPrice);
        qtyInput.data('price', sellingPrice);
    ...
    $(document).ready(function() {
        ...
        $('.item_qty_left').on('keyup', function() {
            calculateTotal();
        });
